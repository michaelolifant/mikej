/*
    ...
    4. Accented and private characters
    ...
    filename with the two-letter CSSO code for your language, e.g.
...
SnapTranslator.dict.klingon = {
    ...
    // tab help
    'costumes tab help':
        "mIllogh DughajmoH vo' page 'ej bebvo' \nlatlh joq vo' De'wI' pong 'oH dragging vaj naDev"
    'import a sound from your computer\nby dragging it into here':
        "wab DughajmoH vo' De'wI' pong 'oH dragging vaj naDev",
    ...
    */
    ...
    'Stage selected:\nno motion primitives':
        'mIw wIv: \npagh ghotvetlhDaq lutlh'

    'move %n steps':
        '%n mIw vIH',
    'turn %clockwise %n degrees':
        'vatlhvI\' %clockwise %n qechmeyDaj Huj tlhe\':',
    'turn %counterclockwise %n degrees':
        'vatlhvI' %counterclockwise %n qechmeyDaj Huj tlhe'',
    'point in direction %dir':
        'lang qaStaHvIS lurgh vatlhvI\' %dir',
    'point towards %dst':
        "lang towards vatlhvI' %dst",
    'go to x: %n y: %n':
        "ghoS x: %n y: vatlhvI' %n",
    'go to %dst':
        'Ha\' vatlhvI\' %dst',
    'glide %n secs to x: %n y: %n':
        'glide %n secs to x: %n y: %n',
    'change x by %n':
        'choH x pong vatlhvI %n',
    'set x to %n':
        "HIjmeH x vatlhvI' %n"
    'change y by %n':
        "y choH pong vatlhvI' %n"
    'set y to %n':
       "HIjmeH y vatlhvI' %n",
    'if on edge, bounce':
        'vaj HeH, bounce',
    ...
    'switch to costume %cst':
        "boch chemvaH Ho'Du' vatlhvI' jech %cst",
    'next costume':
        'veb jech',
    'costume #':
        'Kost\u00fcm Nr.',
